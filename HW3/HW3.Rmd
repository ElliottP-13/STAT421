...
curve((0.95 * x / (0.95 * x + 0.01 * (1-x))), 0, 1, ylab = "Probability individual has had COVID", xlab = "Exposure rate")
```
...
$P(X = 0) = \frac{25 \choose 4}{30 \choose 4} = 0.4616$

$P(X= 1) = \frac{{5 \choose 1}{26 \choose 3}}{30 \choose 4}= 0.4196$

$P(X= 2) = \frac{{5 \choose 2}{26 \choose 2}}{30 \choose 4}= 0.1095$

$P(X= 3) = \frac{{5 \choose 3}{26 \choose 1}}{30 \choose 4}= 0.0091$

$P(X= 4) = \frac{{5 \choose 4}}{30 \choose 4}= 0.0002$
...
vP <- Vectorize(P)
curve(vP, from = -1, to = 5, xlab = "Number of defective microwaves", ylab = "Cumulative Probability", n= 6001)
...
```
2. Now we show the results from (1.)


```{r table, fig.cap="Table of Results"}
table(g_vec)
